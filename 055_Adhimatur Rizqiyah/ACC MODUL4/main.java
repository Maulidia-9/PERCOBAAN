...
abstract class DataKaryawan {
    ...
    public void cetakData() {
        ...
        // String.format digunakan agar tampilan nominal gaji lebih rapi (tanpa desimal yang tidak perlu)
...
class Karyawan extends DataKaryawan {
    ...
    String jadwalGaji(double totalGaji) {
        ...
        // celah angka antara 1.000.000 hingga 1.500.000 agar program tidak error
