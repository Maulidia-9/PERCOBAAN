...
public class PTSinarSosro {
    ...
    static void tambahPegawai() {
        ...
        System.out.print("Jumlah Hadir   : "); int hadir = input.nextInt();
        System.out.print("Gaji Pokok/Dasar: "); int gaji = input.nextInt();

        if (status == 1) {
            daftarPegawai.add(new PegawaiTetap(nik, nama, hadir, gaji));
        } else if (status == 2) {
            System.out.print("Masa Kontrak (bulan): "); int masa = input.nextInt();
