...
class Latihan_E {
    public static void main(String[] args) {
        orang_E org_1 = new orang_E("Lailul 3", 171, 63);
        System.out.println(org_1.toString());
        mahasiswa_E mhs_1 = new mahasiswa_E("Lailul 4", 172, 64, "250531100052", "UTM", 97);
        System.out.println("\n" + mhs_1.toString());
        siswa_E sw_1 = new siswa_E("Lailul siswa", 173, 65, "21081233");
        System.out.println("\n" + sw_1.toString());
        mahasiswalama_E mhslama_1 = new mahasiswalama_E("Lailul mhs lama", 174, 66, "250631100072", "UTM", 97, 4);
        System.out.println("\n" + mhslama_1.toString());
    }
}
