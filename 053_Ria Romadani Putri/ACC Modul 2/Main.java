...
public class Main {
    public static void main(String[] args) {
        Karyawan karyawan1 = new Karyawan("riaa", "Ceo", 2000000);
        Karyawan karyawan2 = new Karyawan("putri", "Manager");
        
        karyawan1.tampilkanInfo();
        karyawan2.tampilkanInfo();
        
        KaryawanPajak karyawanPajak1 = new KaryawanPajak("nir", "Staff", 500000);
