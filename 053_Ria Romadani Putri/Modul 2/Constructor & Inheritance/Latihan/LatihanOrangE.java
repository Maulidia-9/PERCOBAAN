...
class Latihan_E {
    public static void main(String[] args) {
        orang_E org_1 = new orang_E("riaa 3", 150, 40);
        System.out.println(org_1.toString());
        mahasiswa_E mhs_1 = new mahasiswa_E("riaa 4", 150, 40, "250531100053", "UTM", 97);
        System.out.println("\n" + mhs_1.toString());
        siswa_E sw_1 = new siswa_E("riaa siswa", 150, 40, "21081233");
        System.out.println("\n" + sw_1.toString());
        mahasiswalama_E mhslama_1 = new mahasiswalama_E("riaa mhs lama", 150, 40, "250631100053", "UTM", 97, 4);
        System.out.println("\n" + mhslama_1.toString());
    }
}
