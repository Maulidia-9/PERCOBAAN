...
class vivo implements Phone {
    ...
    public void powerOn() {
        ...
        System.out.println("Selamat datang di vivo Y19 s");
...
class Main {
    ...
    public static void main(String[] args) {
        ...
        // Membuat objek HP vivo y19s
        Phone vivo y19s = new vivo();

        // Membuat objek pengguna HP
        PhoneUser riaa = new PhoneUser(vivo y19s);
        ...
        while (true) {
            ...
            // Jika memilih 2
                ...
                // Mematikan HP
               riaa.turnOffThePhone();

            // Jika memilih 3
            } else if (aksi.equalsIgnoreCase("3")) {

                // Memperbesar volume
                riaa.makePhoneLouder();

            // Jika memilih 4
            } else if (aksi.equalsIgnoreCase("4")) {

                // Mengecilkan volume
                riaa.makePhoneSilent();
